...
SNAPSHOT_PATH="${2:-$REPO_ROOT/artifacts/gauntlet-probe/gaunt-mame-oracle-precycle2-f1140-60k.warm.gz}"
SNAPSHOT_FRAMES="${3:-1140}"
CPU_STEPS="${4:-60000}"
...
export EUTHERDRIVE_GAUNTDL_UI_SPEED_SCALE=0.25
