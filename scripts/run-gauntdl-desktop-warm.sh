...
export EUTHERDRIVE_GAUNTDL_EXPERIMENT_RUNTIME_COMPILED_BLOCKS=0
...
export EUTHERDRIVE_GAUNTDL_PARALLEL_VOODOO_TEXTURE_RASTER_MAX_DEGREE=16
...
export EUTHERDRIVE_GAUNTDL_EXPERIMENT_VOODOO_PROFILED_ITERATED_RASTER_KERNEL=1
export EUTHERDRIVE_GAUNTDL_EXPERIMENT_VOODOO_TYPED_RASTER_KERNEL_DISPATCH=1
