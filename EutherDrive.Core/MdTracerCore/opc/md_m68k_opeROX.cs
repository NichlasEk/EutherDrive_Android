    ...
    internal partial class md_m68k
    {
        private void analyse_ROX_reg()
        {
            ...
            if(w_dr == 0)
            {
                ...
                {
                    g_clock += 2;
                    g_work_val1.l = (uint)((g_status_X == true) ?MOSTBIT[w_size]: 0);
                ...
                {
                    g_clock += 2;
                    g_work_val1.l = (uint)((g_status_X == true) ? 1: 0);
                    g_status_C = ((g_work_data.l & MOSTBIT[w_size]) != 0);
                    g_status_X = g_status_C;
                    g_work_data.l = (uint)(g_work_data.l << 1);
                    g_work_data.l = (uint)(g_work_data.l | g_work_val1.l);
                }
            }
            if(w_ir != 0) g_clock += 2;
