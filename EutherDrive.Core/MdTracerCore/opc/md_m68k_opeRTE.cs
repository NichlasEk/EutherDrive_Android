...
namespace EutherDrive.Core.MdTracerCore
{
    internal partial class md_m68k
    {
        private void analyse_RTE()
        {
            ...
            if (md_main.md_m68k.g_interrupt_H_act == true) md_main.md_m68k.g_interrupt_H_act = false;
            else if (md_main.md_m68k.g_interrupt_V_act == true) md_main.md_m68k.g_interrupt_V_act = false;
            else md_main.md_m68k.g_interrupt_EXT_act = false;
