...
namespace EutherDrive.Core.MdTracerCore
{
    ...
    {
        private void analyse_BSET_dynamic_long()
        {
            g_clock += 8;
            g_reg_PC += 2;
        ...
        private void analyse_BSET_dynamic_byte()
        {
            g_clock += 9;
            g_reg_PC += 2;
            int w_bit = (int)g_reg_data[g_op1].l;
        ...
        private void analyse_BSET_static_long()
        {
            g_clock += 12;
            g_reg_PC += 2;
        ...
        private void analyse_BSET_static_byte()
        {
            g_clock += 13;
            g_reg_PC += 2;
            int w_bit = md_main.g_md_bus.read16(g_reg_PC);
