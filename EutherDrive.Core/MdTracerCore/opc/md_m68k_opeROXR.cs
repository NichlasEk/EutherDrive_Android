...
namespace EutherDrive.Core.MdTracerCore
{
    ...
    {
        private void analyse_ROXR_reg()
        {
            // ROXR Dx, Dy or ROXR #<data>, Dy
            // Format: 1110 1sss 1mm1 rrrr
            ...
            // ROXR - Rotate Right through X (bits rotate through X flag)
            ...
            for (int i = 0; i < wcnt; i++)
            {
                ...
                if (g_status_X) g_work_data.l |= msb_bit; // X flag goes to MSB
                g_status_X = lsb;
                g_status_C = lsb;
            }
            ...
            // V flag: always cleared for ROXR
            g_status_V = false;
        }
    }
}