...
namespace EutherDrive.Core.MdTracerCore
{
    internal partial class md_z80
    {
        ...
        {
            if (g_opcode2 == 0x65)      g_write_IXH(g_reg_IXL);
            else if (g_opcode2 == 0x6c) g_write_IXL(g_reg_IXH);
        ...
        {
            if (g_opcode2 == 0x65)      g_write_IYH(g_reg_IYL);
            else if (g_opcode2 == 0x6c) g_write_IYL(g_reg_IYH);
