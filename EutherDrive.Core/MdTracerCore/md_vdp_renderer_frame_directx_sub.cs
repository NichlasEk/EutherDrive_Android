...
namespace EutherDrive.Core.MdTracerCore
{
    public partial class md_vdp
    {
        ...
        {
            var shader = new SharpDX.Direct3D12.ShaderBytecode(
                ShaderBytecode.Compile(in_hlsl_string, in_entrypoint, "cs_5_0", ShaderFlags.Debug)
            );
            ...
            return g_dx_device.CreateComputePipelineState(desc);
        }
    }
}
#endif
