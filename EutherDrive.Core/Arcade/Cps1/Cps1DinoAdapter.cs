    ...
    private sealed class Cps1DinoRomSet
    {
        ...
        private static Dictionary<string, Cps1ClassicDefinition> BuildGeneratedClassicDefinitions()
        {
            ...
            definitions["megaman"] = new Cps1ClassicDefinition(
                ...
                new[]
                {
                    Load(RomLoadKind.WordSwap, 0x0, 0x0, 0x80000, "rcmu_23b.8f", "rcma_23b.8f", "rcm_23a.8f", "rcma_23b.rom"),
                    Load(RomLoadKind.WordSwap, 0x80000, 0x0, 0x80000, "rcmu_22b.7f", "rcma_22b.7f", "rcm_22a.7f", "rcma_22b.rom"),
                    Load(RomLoadKind.WordSwap, 0x100000, 0x0, 0x80000, "rcmu_21a.6f", "rcma_21a.6f", "rcm_21a.6f", "rcma_21a.rom"),
                },
                new[]
                {
                    Load(RomLoadKind.Graphics64Word, 0x0, 0x0, 0x80000, "rcm_01.3a", "rcm_01.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x2, 0x0, 0x80000, "rcm_02.4a", "rcm_02.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x4, 0x0, 0x80000, "rcm_03.5a", "rcm_03.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x6, 0x0, 0x80000, "rcm_04.6a", "rcm_04.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x200000, 0x0, 0x80000, "rcm_05.7a", "rcm_05.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x200002, 0x0, 0x80000, "rcm_06.8a", "rcm_06.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x200004, 0x0, 0x80000, "rcm_07.9a", "rcm_07.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x200006, 0x0, 0x80000, "rcm_08.10a", "rcm_08.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x400000, 0x0, 0x80000, "rcm_10.3c", "rcm_10.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x400002, 0x0, 0x80000, "rcm_11.4c", "rcm_11.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x400004, 0x0, 0x80000, "rcm_12.5c", "rcm_12.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x400006, 0x0, 0x80000, "rcm_13.6c", "rcm_13.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x600000, 0x0, 0x80000, "rcm_14.7c", "rcm_14.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x600002, 0x0, 0x80000, "rcm_15.8c", "rcm_15.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x600004, 0x0, 0x80000, "rcm_16.9c", "rcm_16.rom"),
                    Load(RomLoadKind.Graphics64Word, 0x600006, 0x0, 0x80000, "rcm_17.10c", "rcm_17.rom"),
                },
                new[]
                {
                    Load(RomLoadKind.Raw, 0x0, 0x0, 0x8000, "rcm_09.11a", "rcm_09.12a", "rcm_09.rom"),
                    Load(RomLoadKind.Raw, 0x10000, 0x8000, 0x8000, "rcm_09.11a", "rcm_09.12a", "rcm_09.rom"),
                },
                new[]
                {
                    Load(RomLoadKind.Raw, 0x0, 0x0, 0x20000, "rcm_18.11c", "rcm_18.rom"),
                    Load(RomLoadKind.Raw, 0x20000, 0x0, 0x20000, "rcm_19.12c", "rcm_19.rom"),
                });
