                ...
                if (mainSlice > 0)
                {
                    ...
                    if (_useM68kEmu)
                    {
                        ...
                        while (remaining > 0)
                        {
                            ...
                            if (_useM68kEmu && subSlice > 0)
                            {
                                long mainCyclesDone = mainSlice - remaining;
                                int desiredSubCycles = (int)((mainCyclesDone * (long)subSlice) / Math.Max(1, mainSlice));
                                while (subCyclesInterleaved < desiredSubCycles)
                                {
