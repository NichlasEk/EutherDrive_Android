...
namespace mame
{
    partial class mcr_state : driver_device
    {
        ...
        protected int8_t m_mcr12_sprite_xoffs_flip = 0;
        protected uint8_t m_input_mux = 0;
        protected uint8_t m_last_op4 = 0;
        protected tilemap_t m_bg_tilemap = null;

        protected uint8_t m_mcr_cocktail_flip = 0;

        protected required_device<z80_device> m_maincpu;
        protected optional_shared_ptr<uint8_t> m_spriteram;
        protected optional_shared_ptr<uint8_t> m_videoram;
        protected optional_shared_ptr<uint8_t> m_paletteram;

        protected required_device<z80ctc_device> m_ctc;
        protected optional_device<midway_ssio_device> m_ssio;
        protected optional_device<midway_cheap_squeak_deluxe_device> m_cheap_squeak_deluxe;
        protected optional_device<midway_sounds_good_device> m_sounds_good;
        protected optional_device<midway_turbo_cheap_squeak_device> m_turbo_cheap_squeak;
        protected optional_device<bally_squawk_n_talk_device> m_squawk_n_talk;
        protected optional_device<samples_device> m_samples;
        protected required_device<gfxdecode_device> m_gfxdecode;
        protected required_device<palette_device> m_palette;


        protected uint32_t m_mcr_cpu_board = 0;
        protected uint32_t m_mcr_sprite_board = 0;

        protected int8_t m_mcr12_sprite_xoffs = 0;
