...
namespace mame
{
    ...
    public class configuration_manager
    {
        ...
        {
            // EutherDrive embeds MCS without MAME's full frontend config UI.
            // Treat existing config files as optional until XML config support is ported.
            return true;
        }
        ...
        {
            // MCS can run arcade drivers without persisting MAME XML config.
            return true;
        }
    }
}
