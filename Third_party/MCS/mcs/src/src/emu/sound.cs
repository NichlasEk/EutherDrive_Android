    ...
    ***************************************************************************/
    ...
    public class sound_manager
    {
        ...
        public sound_manager(running_machine machine)
        {
            ...
            m_finalmix = new std.vector<s16>(machine.sample_rate() * 2);
        ...
        void update(s32 param = 0)
        {
            ...
            if ((u32)m_leftmix.size() < m_samples_this_update)
                m_leftmix.resize(m_samples_this_update);
            if ((u32)m_rightmix.size() < m_samples_this_update)
                m_rightmix.resize(m_samples_this_update);
            ...
            if (finalmix_step == 0)
                finalmix_step = 1000;
            u32 finalmix_samples = (m_samples_this_update * 1000 + finalmix_step - 1) / finalmix_step;
            u64 finalmix_capacity = (u64)(finalmix_samples * 2 + 2);
            if (m_finalmix.size() < finalmix_capacity)
                m_finalmix.resize(finalmix_capacity);
