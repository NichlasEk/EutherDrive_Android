...
namespace mame.plib
{
    public static class pstonum_global
    {
        ...
        public static float pstonum_float(string arg) { return float.Parse(arg, CultureInfo.InvariantCulture); }
        public static double pstonum_double(string arg) { return double.Parse(arg, CultureInfo.InvariantCulture); }
