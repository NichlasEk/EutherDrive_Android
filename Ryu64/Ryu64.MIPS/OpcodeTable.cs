    ...
    public class OpcodeTable
    {
        ...
        public static void Init()
        {
            ...
            */
            ...
            SetOpcode("01000110000XXXXXXXXXXXXXXX001001", InstInterp.TRUNC_L_S, "TRUNC.L.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001010", InstInterp.CEIL_L_S, "CEIL.L.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001011", InstInterp.FLOOR_L_S, "FLOOR.L.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001100", InstInterp.ROUND_W_S, "ROUND.W.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001101", InstInterp.TRUNC_W_S, "TRUNC.W.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001110", InstInterp.CEIL_W_S, "CEIL.W.S F[{3}], F[{2}]");
            SetOpcode("01000110000XXXXXXXXXXXXXXX001111", InstInterp.FLOOR_W_S, "FLOOR.W.S F[{3}], F[{2}]");
            ...
            SetOpcode("01000110001XXXXXXXXXXXXXXX001001", InstInterp.TRUNC_L_D, "TRUNC.L.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001010", InstInterp.CEIL_L_D, "CEIL.L.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001011", InstInterp.FLOOR_L_D, "FLOOR.L.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001100", InstInterp.ROUND_W_D, "ROUND.W.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001101", InstInterp.TRUNC_W_D, "TRUNC.W.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001110", InstInterp.CEIL_W_D, "CEIL.W.D F[{3}], F[{2}]");
            SetOpcode("01000110001XXXXXXXXXXXXXXX001111", InstInterp.FLOOR_W_D, "FLOOR.W.D F[{3}], F[{2}]");
